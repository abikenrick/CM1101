...
def normalise_input(user_input):
    ...
    x = user_input.split()
    print(x) #inspired by W3 Schools code
    #this line splits strings into words
    x = user_input.strip()
    print(x)
    #this line removes any extra spaces between words

    import textcleaner as tc #text cleaner is imported
    #words are removed from the string the user inputs
    filter_words = tc.document(gameparser.py)#the variable filter_words is assigned
    #to this document and assigns the text cleaner to this document
    user_input.remove_stpwrds()#this function removes stop words (unimportant words)
    #I took this chunk of code from stack overflow
